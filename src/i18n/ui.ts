...
export const ui = {
  en: {
    ...
    'ballot.samplePdfLink': 'View your sample ballot',
    ...
    'elections.initiativesHeading': 'Ballot Initiatives',
    ...
    'elections.fullText': 'Full Text',
    'elections.rowHint': 'Click on a row to see the full text of the initiative.',
    'elections.ballotFor': 'For',
    'elections.ballotAgainst': 'Against',
    'elections.ballotYes': 'Yes',
    'elections.ballotNo': 'No',
    'elections.ballotSourcePrefix': 'Text as it appears on the ballot. Source: ',
  ...
  es: {
    ...
    'ballot.samplePdfLink': 'Ver tu boleta de muestra',
    ...
    'elections.title': 'Próxima Elección',
    ...
    'elections.introSuffix': '.',
    'elections.initiativesHeading': 'Iniciativas Electorales',
    ...
    'elections.fullText': 'Texto completo',
    'elections.rowHint': 'Haz clic en una fila para ver el texto completo de la iniciativa.',
    'elections.ballotFor': 'A favor',
    'elections.ballotAgainst': 'En contra',
    'elections.ballotYes': 'Sí',
    'elections.ballotNo': 'No',
    'elections.ballotSourcePrefix': 'Traducción no oficial del texto de la boleta. Texto oficial en inglés: ',
